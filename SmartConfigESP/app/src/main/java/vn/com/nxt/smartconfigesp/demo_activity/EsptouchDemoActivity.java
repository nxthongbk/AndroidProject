package vn.com.nxt.smartconfigesp.demo_activity;

import java.util.List;

import vn.com.nxt.smartconfigesp.DeviceDetail;
import vn.com.nxt.smartconfigesp.EsptouchTask;
import vn.com.nxt.smartconfigesp.IEsptouchListener;
import vn.com.nxt.smartconfigesp.IEsptouchResult;
import vn.com.nxt.smartconfigesp.IEsptouchTask;
import vn.com.nxt.smartconfigesp.MainActivity;
import vn.com.nxt.smartconfigesp.R;
import vn.com.nxt.smartconfigesp.task.__IEsptouchTask;
		...
		protected void onPostExecute(List<IEsptouchResult> result) {
			...
			if (!firstResult.isCancelled()) {
				...
				if (firstResult.isSuc()) {
					...
					Toast.makeText(EsptouchDemoActivity.this, "Adding successfully"+sb.toString(), Toast.LENGTH_SHORT).show();

					//mProgressDialog.setMessage(sb.toString());
				} else {
					Toast.makeText(EsptouchDemoActivity.this, "Adding fail", Toast.LENGTH_SHORT).show();
					//mProgressDialog.setMessage("Esptouch fail");
				}
			}
		}
